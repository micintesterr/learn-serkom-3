<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('products.index') }}" class="text-sm font-bold text-blue-600 hover:underline uppercase tracking-tight">
                &larr; Kembali
            </a>
        </div>
    </x-slot>
        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white border border-gray-300 shadow-sm overflow-hidden">
                <div class="p-4 bg-gray-100 border-b border-gray-200">
                    <p class="text-xs font-bold text-gray-500 uppercase tracking-widest">Formulir Perubahan Data {{ $product->id }}</p>
                </div>

                <form action="{{ route('products.update', $product->id) }}" method="POST" id="product-form" class="p-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="space-y-5">
                        ...
                        <div>
                            <label class="block text-xs font-bold text-gray-600 uppercase mb-1">Deskripsi Produk</label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                <label class="block text-xs font-bold text-gray-600 uppercase mb-1">Harga (Rp)</label>
    ...
    <script>
        ...
        const validators = {
            ...
            min: (v, a) => v === '' || Number(v) >= Number(a) || `Minimal ${a}`,
        };
        ...
        function validateField(f) {
            ...
            f.style.borderColor = error ? '#dc2626' : ''; // Red-600
            return !error;
        }
